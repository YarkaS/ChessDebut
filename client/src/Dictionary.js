...
const openingsArray = [
  ...
  },
  {
    ...
    description: "Black doesn't pay attention to basic chess concepts such as a pawn center or strong pair of bishops. Black's main plan is to develop as quickly and as aggressive as possible and start an attack against the White king. ",
  },
  {
    id: 12,
    value: "Danish Gambit",
  ...
  },
  {
    ...
    picture: <img src=""/>,
    moveOrder: "1.d4 f5",
    description: "Visually, the Dutch Defense looks like an opposite Sicilian. However, the placement of the King makes this very different. Pawn to f5 gains space, but can weaken the king's position after castling. ",
  },
  {
    id: 14,
    ...
    picture: <img src=""/>,
    moveOrder: "1.c4",
    description: "White chooses to fight for the center by moving a wing-pawn. However, moving the pawn to c4 doesn't really help develop anything, but moving the knight to c3 can help solidify White's claim on the center. ",
  },
  {
    id: 15,
    value: "Evans Gambit",
    ...
    description: "An aggressive line of the Giuoco Piano. White offers a pawn to challenge Black's bishop on c5. The most popular use of this gambit is the Evergreen game won by Adolf Anderssen against Jean Dufresne.  ",
  },
  {
    id: 16,
  ...
  },
  {
    ...
    picture: <img src=""/>,
    moveOrder: "1.e4 e6",
    description: "Named after a 1834 game between the cities of London and Paris where the French defense was first utilized, Black attempts to follow e6 with d5 and tries to fight the e4 pawn. This blocks in the light squared bishop, but gives Black a very solid pawn chain. ",
  },
  {
    id: 19,
    value: "Giuoco Piano",
  ...
  },
  {
    ...
    description: "Italian for 'Very Quiet Game'. White aims for a slow buildup play, deferring the pawn push to d4 until it is the right time. By avoiding a confrontation in center, White can enter a positional maneuvering game through a series of exchanges. ",
  },
  {
    id: 21,
    ...
    description: "Black gives White a strong center and a space advantage, but uses the d5 pawn to fight for the center. ",
  },
  {
    id: 22,
  ...
  },
  {
    ...
    description: "First played by Italian chess masters as early as the 16th century, White develops its light squared bishop to a strong diagonal aiming at f7 and g8. ",
  },
  {
    id: 24,
    value: "King's Gambit",
    ...
    description: "White sacrifices its pawn on f4 to remove Black's pawn on e5. Ideally, White would like to take back the pawn while also commanding the center. This comes at a price of the king being very vulnerable. ",
  },
  {
    id: 25,
    ...
    description: "Black, more often than not, will accept the gambit. White has two main ways to continue this line. The first is bishop to c4, which starts the Bishop's Gambit. The second is knight to f3 which also prevents Black's queen from moving to h4. ",
  },
  {
    id: 26,
    ...
    description: "Also called the Falkbeer Countergambit, Black will push its pawn to d5. After White captures the d5 pawn, Black will move its pawn to e4. At the cost of sacrificing a pawn, Black makes quick and easy development. However, White can respond by moving its pawn to d3. ",
  },
  {
    id: 27,
    ...
    description: "After Nf6 for black, White typically moves the Bishop by Bg2, then follows it up with king-side castle",
  },
  {
    id: 28,
    ...
    description: "Considered a 'hypermodern' defense, Black allows White to develop a pawn center, but with moves such as bishop to g7 and pawn to d6, Black has great counter-attacking chances. Black can fight back with moves such as e5 or c5. ",
  },
  {
    id: 29,
  ...
  },
  {
    ...
    description: "Created by Chess grandmaster Aron Nimzowitsch, each of black's moves are made to control the e5 and d4 squares with the pieces rather than the pawns. The move bishop to b4 pinning the White knight on c3 is the defining move of the Nimzo-Indian.",
  },
  {
    id: 31,
    ...
    picture: <img src=""/>,
    moveOrder: "1.b3",
    description: "By moving the pawn to b3, White chooses to next move its bishop to b2. The bishop on b2 puts massive pressure down the long diagonal. However, this leads to slow kingside development for White and the knight on b1 may find a good position hard to come by. ",
  },
  {
    id: 32,
  ...
  },
  {
    ...
    description: "Black allows White to take over the center with pawns, but then attempts to counter-attack the pawn center. This move always involves the bishop moving to g7; if that move is not played as soon as possible, then it is not the Pirc defense. However, careful and correct play by White can restrict Black.",
  },
  {
    id: 35,
    ...
    picture: <img src=""/>,
    moveOrder: "1.b4",
    description: "Opens a line of development for the dark squared bishop to move to b2 if thats where the player chooses to move it. However, the pawn on b4 has no natural defender and if Black moves his e pawn, then the White pawn will immediately be under attack by Black's dark squared bishop. ",
  },
  {
    id: 36,
    ...
    description: "White strikes at Black's central pawn on e5 from the side. Although the c4 pawn isn't guarded, White can always get the pawn back should they choose to do so, however this comes at the expense of a few turns. ",
  },
  {
    id: 37,
  ...
  },
  {
    ...
    description: "Another opening conceived by Aron Nimzowitsch, White refuses to allow the pin of bishop to b4 by instead playing knight to f3. Black responds by moving its bishop to b7, thereby fighting for control of the center from a distance. However, Black must be careful not to shut out its bishop from the game, something a move like pawn to d4 can indirectly do.  ",
  },
  {
    id: 40,
    ...
    description: "Although it appears like a mirror of the popular Ruy Lopez, the fundamentals of this opening are quite different. White goes for fast development on the queenside, whereas Black will do the same on the kingside. Players will typically castle on opposite sides of the board. White's play revolves around getting a strong pawn center with pawn to e4. Black, on the other hand, can attempt to counter that with playing bishop to b4 and pinning the knight. ",
  },
  {
    id: 41,
    value: "Ruy Lopez",
    ...
    description: "One of the most popular openings in chess, White moves its bishop to b5 and puts immediate pressure on the knight guarding the center while also developing rapidly. ",
  },
  {
    id: 42,
    ...
    picture: <img src=""/>,
    moveOrder: "1.e4 d5",
    description: "This is the oldest recorded move by Black. Black's goal is to prevent White from controlling the center of the board. White will normally take the Black pawn and Black can continue by recapturing the pawn with its queen, thereby bringing the queen into the game. ",
  },
  {
    id: 43,
    value: "Scotch Game",
  ...
  },
  {
    ...
    picture: <img src=""/>,
    moveOrder: "1.e4 c5",
    description: "One of the major answers to White's e4 pawn, Black takes control of the d4 square and avoids giving White a central target. It gives both sides great chances to attack the other. ",
  },
  {
    id: 45,
    value: "Slav Defense",
    ...
    description: "This is one of the primary defenses to the Queen's gambit. In most Queen's Gambit Declined variations, Black's light squared bishop is stuck. In this opening, the light squared bishop is free to move to f5 or g4. However, Black must be careful when to move the bishop. If the bishop is moved too early, White can push its pawn to c5, thereby establishing a further dominance on the center and incurring a loss of tempo for Black. ",
  },
  {
    id: 46,
    value: "Vienna Game",
    ...
    description: "Instead of playing knight to f3 and attacking the black pawn, White chooses to focus on defense and moves it other knight to c3. This gives White options with being aggressive with pawn to d4 or being patient with pawn to g3 and bishop to g2. ",
  },
];
